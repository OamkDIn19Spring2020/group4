...
<body onload="selector()">
    ...
    <div id="loginbox" >
        <form name="login" action="login.php" method="post">
            ...
            <input type="text" placeholder="Password" name="Password1" type="password" class="textinp"><br><br><br>
    ...
    <div id="registerbox" >
        <form name="register" action="register.php" method="post">
            ...
            <input type="text" placeholder="Password"  name="Password" type="password"class="textinp"><br><br><br>
